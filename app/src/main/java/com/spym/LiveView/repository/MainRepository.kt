package com.spym.LiveView.repository
...
import com.spym.LiveView.webrtc.MyPeerObserver
import com.spym.LiveView.webrtc.WebRTCClient
...
class MainRepository @Inject constructor(
    ...
    fun sendConnectionRequest(target: String,isFront: Boolean, isVideoCall: Boolean, success: (Boolean) -> Unit) {
